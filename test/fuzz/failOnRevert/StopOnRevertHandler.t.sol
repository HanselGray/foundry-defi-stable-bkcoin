...
contract StopOnRevertHandler is Test {
    ...
    constructor(BKEngine _dscEngine, BKCoin _dsc) {
    ...
    function retrieveCollateral(uint256 collateralSeed, uint256 amountCollateral) public {
        ...
        vm.prank(msg.sender);
        dscEngine.retrieveCollateral(address(collateral), amountCollateral);
    }

    function burnBKC(uint256 amountDsc) public {
        ...
        dscEngine.burnBKC(amountDsc);
        vm.stopPrank();
    }

    // Only the BKEngine can mint DSC!
